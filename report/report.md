...
# Results
The features that were analyzed were quantitative values. Thus, it was decided that histograms were the best plots for examining and comparing the data. The first feature that was analyzed is "danceability".  ![danceability](images/danceability_histogram_before_and_after_21stcentury.png)   
